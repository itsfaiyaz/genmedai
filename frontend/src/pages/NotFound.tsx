...
const NotFound = () => {
    return (
        <div className="min-h-[80vh] flex flex-col items-center justify-center p-4 text-center animate-in fade-in duration-500">
            <div className="mb-8 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <div className="bg-white dark:bg-gray-950 p-4 rounded-full shadow-sm mb-4">
                        <FileQuestion className="w-12 h-12 text-brand-teal" />
                    </div>
                    <span className="text-xl sm:text-2xl font-bold text-brand-navy dark:text-white uppercase tracking-widest bg-white/50 dark:bg-gray-950/50 backdrop-blur-sm px-4 py-1 rounded-lg">
                        Page Not Found
                    </span>
                </div>
            </div>
            ...
            <Link
                to="/"
                className="inline-flex items-center gap-2 px-8 py-3 bg-brand-gradient text-white font-bold rounded-full shadow-lg shadow-brand-blue/20 hover:shadow-brand-blue/40 hover:-translate-y-1 transition-all duration-300"
            >
