                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-2">
                            <div className="w-10 h-10 bg-[#2DD4BF] rounded-full flex items-center justify-center text-white font-bold text-xl shadow-sm">
                                <Pill className="w-6 h-6 fill-current" />
                            </div>
                            <span className="font-bold text-2xl tracking-tight text-white">GenMed<span className="text-[#2DD4BF]">AI</span></span>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-400">
                            <li>
                                <Link to="/" className="hover:text-[#2DD4BF] transition-colors">Home</Link>
                            </li>
                            <li>
                                <Link to="/how-it-works" className="hover:text-[#2DD4BF] transition-colors">How It Works</Link>
                            </li>
                            <li>
                                <Link to="/about" className="hover:text-[#2DD4BF] transition-colors">About Us</Link>
                            </li>
                            <li>
                                <Link to="/faqs" className="hover:text-[#2DD4BF] transition-colors">FAQs</Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-400">
                            <li>
                                <Link to="/privacy-policy" className="hover:text-[#2DD4BF] transition-colors">Privacy Policy</Link>
                            </li>
                            <li>
                            ...
                            <li>
                                {isLoggedIn ? (
                                    <div className="flex flex-col gap-2">
                                        <Link to="/my-account" className="font-bold text-white hover:text-[#2DD4BF]">My Account</Link>
                                        {hasDeskAccess && (
                                            <a href="/app" className="font-bold text-white hover:text-[#2DD4BF]">Go to Desk</a>
                                        )}
                                    </div>
                                ) : (
                                    <Link to="/login" className="hover:text-[#2DD4BF] transition-colors">Login / Sign Up</Link>
                                )}
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-4 text-sm text-gray-400">
                            ...
                            <div className="flex space-x-4 pt-4">
                                <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-[#2DD4BF] hover:text-white transition-all duration-300">
